...
class Todo(graphene.ObjectType):
    ...
    def resolve_todo_items(self, info, **kwargs):
...
class Query(graphene.ObjectType):
    ...
    def resolve_todo(self, info, id, **kwargs):
        ...
        data = Todo(id=response['id'], name=response['name'], todo_items=response['todo_items'])
        return data


    def resolve_todo_item(self, info, id, **kwargs):
